          ...
          <Container>
            <div className=' grid gap-3 md:grid-cols-2'>
                ...
                <section className=' text-center items-center'>
                    <div className='sm:mt-2 md:flex gap-4 md:justify-around'>
                    ...
                    <div className='md:mt-2 md:flex gap-4 md:justify-around'>
                    ...
                    <br /> 
                    <button className=' btn bg-red-400 rounded-lg px-4 py-1' type="button"> Submit</button>
                    </div>
